...
const CreateInterviewForm = () => {
  const [state, formAction, isPending] = useActionState(
    handleCreateInterviewFormAction,
    initialState
  );
          ...
          <form action={formAction} className="flex flex-col gap-6">
                ...
                return (
                  ...
                  >
                    {item.map((question, subIndex) => (
                      ...
                      >
                        <Label className="leading-5" htmlFor={question.name}>
                          {question.label}
                        </Label>
                        {question.type === "input" ? (
                          <Input
                          ...
                          Array.isArray(question.options) && (
                            ...
                            >
                              <SelectTrigger className="w-full">
                                <SelectValue
                                  placeholder={question.defaultOption}
                                />
                              </SelectTrigger>
                              <SelectContent>
                                <SelectGroup>
            ...
            >
              {isPending ? (
                ...
                <span className="flex-1">Create Interview</span>
              )}
